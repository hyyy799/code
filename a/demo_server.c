...
void write_2clients_int(int * cli_sockfd, int msg);
...
void send_update(int * cli_sockfd, int move, int player_id)
{
    ...
    write_2clients_msg(cli_sockfd, "UPD");
    write_2clients_int(cli_sockfd, player_id);
    write_2clients_int(cli_sockfd, move);
...
void *run_game(void *thread_data) 
{
    ...
    write_2clients_msg(cli_sockfd, "SRT");
    ...
    while(!game_over) {
	    ...
	    if (move == -1) { 
            ...
            if (game_over == 1) {
                ...
                write_2clients_msg(cli_sockfd, "DRW");
                game_over = 1;
            }
